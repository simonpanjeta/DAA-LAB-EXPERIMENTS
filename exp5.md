Implement quicksort by considering pivot as first element, last element, mid element and random element. Perform time (best, worst, and average) and space complexity analysis.
